    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                  ...
                  <h6 class="m-0 font-weight-bold text-primary">방영</h6>
                </div>
				    <div class="card shadow mb-4">
		 ...
		 <form name="form1" action="showfinal.jsp" method="post">
