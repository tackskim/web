...
<title>SB Admin 2 - Buttons</title>
  ...
  <link href="../../css/Admin/sb-admin-2.css" rel="stylesheet">
  	...
  	<!-- Image -->
  <link rel="stylesheet" href="../../css/Admin/jquery.flipster.min.css">

  <script src="../../js/Admin/jquery.min.js"></script>
  <script src="../../js/Admin/jquery.flipster.min.js"></script>
</head>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Drama</h1>
    	...
    	<tbody>
        <form action="ANEWSWrite.do" method="post" enctype="Multipart/form-data">
            <tr>
                <th>제목: </th>
                <td><input type="text" placeholder="제목을 입력하세요. "  name="RELEASES_TITLE" id= "RELEASES_TITLE" class="form-control"/></td>
            </tr>
            <tr>
                <th>내용: </th>
                <td><textarea cols="10" placeholder="내용을 입력하세요. " name="RELEASES_CONTENT" id = "RELEASES_CONTENT" class="form-control"></textarea></td>
            </tr>
			 <tr>
                <th>날짜: </th>
               <td >
  <div><input type="date" id="RELEASES_DATE" name="RELEASES_DATE"
                value="2019-08-27"></div>
  </td>
            </tr>
			

 <tr>
      <td>파일명 : </td><td><input type="file" name="img" id="img" >
            ...
            <tr>
                <td colspan="2">
                    ...
                    <button type="button" value="글 목록으로... " onclick="window.history.back()" class="pull-right">글 목록으로...</button>
