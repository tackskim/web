...
<!-- Mirrored from www.studiodragon.net/front/kr/career/recruit?career=CA by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Aug 2019 10:25:13 GMT -->
...
<div id="wrap">
	...
	<div id="container">
		<div class="content">
			<div class="tab">
				<ul>
					<li ><a href="TotalRecru.do">전체</a></li>
					<li class="on"><a href="CareerRecru.do">경력</a></li>
			...
			<div class="srchArea tabBtm">
				...
				<input type="hidden" name="career" id="career" value="CA"/>
