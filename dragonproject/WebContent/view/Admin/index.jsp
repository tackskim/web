      ...
      <li class="nav-item">
        ...
        <div id="collapsePage3" class="collapse" aria-labelledby="headingPa" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" "buttons0.1.jsp">Press Releases</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePage4" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
	       ...
	       <a class="collapse-item" href="AdViewerListAction.do">시청자의견 게시판관리</a>
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Sales (2018)</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">$379,600,000</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Sales (2017)</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">$286,800,000</div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
           ...
           <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Sales (2016)</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">$154,400,000</div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
           ...
           <!-- <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <h4 class="small font-weight-boldn">Payout Details <span class="float-right">80%</span></h4>
                  <div class="progress mb-4">
              ...
              <div class="row">
                <div class="col-lg-6 mb-4">
                  <div class="card bg-primary text-white shadow">
                    <div class="card-body">
                      CJ ENM
                      <div class="text-white-50 small">20,000,000(71.3%)</div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 mb-4">
                  <div class="card bg-success text-white shadow">
                    <div class="card-body">
                      특수관계인
                      <div class="text-white-50 small">857,267(3.1%)</div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 mb-4">
                  <div class="card bg-info text-white shadow">
                    <div class="card-body">
                      기관
                      <div class="text-white-50 small">3,700,092(13.2%)</div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 mb-4">
                  <div class="card bg-warning text-white shadow">
                    <div class="card-body">
                      외국인
                      <div class="text-white-50 small">798,874(2.9%)</div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 mb-4">
                  <div class="card bg-danger text-white shadow">
                    <div class="card-body">
                      개인
                      <div class="text-white-50 small">2,632,165(9.3%)</div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 mb-4">
                  <div class="card bg-secondary text-white shadow">
                    <div class="card-body">
                      우리사주
                      <div class="text-white-50 small">28,051,490(100%)</div>
                    </div>
                  </div>
                </div>
              </div>
