...
<head>
 ...
 <title>SB Admin 2 - Buttons</title>
  ...
  <link href="../../Vender/fontawesome-free/css/all.css" rel="stylesheet" type="text/css">
      ...
      <!--<li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="buttons.jsp">규정 및 정책</a>
          </div>
        </div>
      </li>-->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">RECRUITMENT</h1>
       ...
       <form name="form1" action="ARECRU.do" method="post">
            ...
            <div class="card-header py-3">
              ...
              <h6 class="m-0 font-weight-bold text-primary">채용공고</h6>
            </div>
            <div class="card-body">
...
<table class="table table-bordered">
    ...
    <tbody>
        <form action="ARECRU.do" method="post" >
        <tr>
        <td colspan="2">
            ...
            <tr>
                <th>제목: </th>
                <td><input type="text" placeholder="제목을 입력하세요. " name=CAREER_TITLE id=CAREER_TITLE class="form-control"/></td>
            </tr>
            <tr>
                <th>내용: </th>
                <td><textarea cols="10" placeholder="내용을 입력하세요. " name=CAREER_CONTENT id=CAREER_CONTENT class="form-control"></textarea></td>
            </tr>
            <tr>
                <td colspan="2">
  ...
  <script src="../../js/Admin/polaroid.min.js"></script>
