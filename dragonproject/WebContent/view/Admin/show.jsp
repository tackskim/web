			...
			<a
				...
				<div class="sidebar-brand-icon rotate-n-15">
					<img class="small_img" src="../../img/Admin/adminpage/drgon.png"
						alt="이미지">
				</div> <!--        <div class="sidebar-brand-text mx-3">DRAGON <sup>studio</sup></div>-->
			</a>
				 ...
				 <INPUT TYPE="SUBMIT" VALUE="글쓰기" STYLE="HEIGHT:20">
								...
								<div class="card-body">
									...
									<table class="table table-bordered">
										...
										<tbody>
											<form action="ANEWSWrite.do" method="post"
												...
												<tr>
													<th>극본:</th>
													<td><textarea cols="10" placeholder="내용을 입력하세요. "
															name="content1" class="form-control"></textarea></td>
												</tr>
												<tr>
													<th>출연:</th>
													<td><textarea cols="10" placeholder="내용을 입력하세요. "
															name="content2" class="form-control"></textarea></td>
												</tr>
											...
											<td colspan="2"><input type="SUBMIT" value="등록"
												...
												type="RESET" value="reset" class="pull-left" /> <input
												type="button" value="글 목록으로... " class="pull-right"
												onclick=history.go(-1) /> <!-- <a class="btn btn-default" onclick="sendData()"> 등록 </a>
