    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.jsp">
        <div class="sidebar-brand-icon rotate-n-15">
          <img class="small_img" src="../drgon.png" alt="ì´ë¯¸ì§">
        </div>
   ...
   <!--   <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="buttons1.jsp">ê·ì  ë° ì ì±</a>
          </div>
        </div>
      </li>-->
      ...
      <li class="nav-item">
        ...
        <div id="collapsePage4" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
	       ...
	       <a class="collapse-item" href="tables.jsp">ìì²­ììê²¬ ê²ìíê´ë¦¬</a>
	

			  
			<!--  <h6 class="collapse-header">FINANCIAL INFORMATION</h6>
			<a class="collapse-item" href=href="tables.jsp">ì¬ìë³´ê³ ì</a>
			<a class="collapse-item" href=href="tables.jsp">ê°ì¬/ê²í  ë³´ê³ ì</a>

			 <h6 class="collapse-header">CORPORATE GOVERNANCE</h6>
			  
			<a class="collapse-item" href="tables.jsp">ì´ì¬í êµ¬ì±</a>
			<a class="collapse-item" href="tables.jsp">ì´ì¬í ê°ìµíí©</a>-->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="https://www.instagram.com/p/B0iUfTulnTP/?igshid=1o2ce9z9whuy2">
                  ...
                  <div class="dropdown-list-image mr-3">
                     <img class="small2_img" src="../sh.png" alt="ì´ë¯¸ì§">
                    <div class="status-indicator bg-success"></div>
                  </div>
                  <div class="font-weight-bold">
                    <div class="text-truncate">ìë!ëë ììì ì±ìì§ë ììì¬ì¼!</div>
                    <div class="small text-gray-500"> Seo Hyeon Â· 58m</div>
                  </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="https://www.instagram.com/p/BoO-teaBoJe/?igshid=dq8qd6p4onub">
                  <div class="dropdown-list-image mr-3">
                     <img class="small2_img" src="../tiger.png" alt="ì´ë¯¸ì§">
                    <div class="status-indicator"></div>
                  </div>
                  <div>
                    <div class="text-truncate">ìë!?ëë ì¸ììì ì ì¼ ê°ë ì ë²ì´ì¼!</div>
                    <div class="small text-gray-500">Jeong tiger Â· 10m</div>
                  </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="https://www.instagram.com/p/Blz0pXWFJX7/?igshid=126zmvw3d0jpb">
                  <div class="dropdown-list-image mr-3">
                     <img class="small2_img" src="../tak.png" alt="ì´ë¯¸ì§">
                    <div class="status-indicator bg-warning"></div>
                  </div>
                  <div>
                    <div class="text-truncate">ìë!ì½ë©ìì¼ë©´ ì ë§ ëª»ì´ì ëë ì´ëìë  ì½ë©íì°ì¼!</div>
                    <div class="small text-gray-500">Tak Woo Â· 22m</div>
                  </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="small2_img" src="../star.png" alt="ì´ë¯¸ì§">
                    <div class="status-indicator bg-success"></div>
                  </div>
                  <div>
                    <div class="text-truncate">ëµ¤ë¦¬ìëë¤. ë³´ê³ ì¶ì´ì â¥</div>
                    <div class="small text-gray-500">Star Â· 20m</div>
                  </div>
                </a>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">ê·ì  ë° ì ì±</h1>
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">ë´ë¶ì ë³´ê´ë¦¬ê·ì </h6>
                </div>
				  
                <div class="card-body">
                  <p>ì¤íëì¤ ëëê³¤ ì£¼ìíì¬</p>
