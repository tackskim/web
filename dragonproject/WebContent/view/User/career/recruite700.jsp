...
<!-- Mirrored from www.studiodragon.net/front/kr/career/recruit?career=IN by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Aug 2019 10:25:14 GMT -->
...
<div id="wrap">
				...
				<ul>
					...
					<li class="on"><a href="talent.jsp" class="menu1 transit">CAREERS</a>
						<ul>
							...
							<li class="on"><a href="recruit.jsp">FEATURED JOBS</a></li>
						</ul>
					</li>
	...
	<div id="container">
		<div class="content">
			<div class="tab">
				<ul>
					<li ><a href="recruit.jsp">전체</a></li>
					<li ><a href="recruite00d.jsp?career=CA">경력</a></li>
					<li ><a href="recruit9320.jsp?career=NE">신입</a></li>
					<li class="on"><a href="InternRecru.do">인턴</a></li>
				</ul>
			</div>
			<div class="srchArea tabBtm">
				<form name="searchForm" id="searchForm" method="post">
				<input type="hidden" name="cpage" id="cpage" value="1"/>
				<input type="hidden" name="career" id="career" value="IN"/>
