...
<!-- Mirrored from www.studiodragon.net/front/kr/works/portfolio?class1=O by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Aug 2019 10:25:11 GMT -->
<!-- Added by HTTrack -->
				...
				<div id="gnb" class="">
					...
					<ul>
						...
						<!-- <li><a href="../ir/activities.jsp" class="menu1 transit">IR</a>
							<ul>
								<li><a href="../ir/activities.jsp">IR ACTIVITIES
										&amp; MATERIALS</a></li>
								...
								<li><a href="../ir/governance.jsp">CORPORATE
										GOVERNANCE</a></li>
							</ul></li> --> -->
					</ul>
				</div>
			...
			<div class="content">
				<div class="tab">
					<ul>
						...
						<li class="on"><a href="PortfolioOn.do">방영</a></li>
...
<%} %>
		...
		<form name="form" id="form"
			...
			<input type="hidden" name="class1" id="class1" value="O" /> <input
							...
							success : function(data) {
								...
								if (data.list.length > 0) {
									for (var i = 0; i < data.list.length; i++) {
										innerHtml += '<li>';
										//innerHtml +='<a href="/front/kr/works/portfolio_view?class1=O&idx='+data.list[i].idx+'" target="_self">';
										innerHtml += '<a href="javascript:void(0)" onclick="fnView('
												+ data.list[i].idx + ')">';
										if (data.list[i].thum_img != null
												&& data.list[i].thum_img != "") {
										...
										innerHtml += '<dl>';
										innerHtml += '<dt>'
												+ data.list[i].title + '</dt>';
										innerHtml += '<dd>';
										innerHtml += '<ul>';
										innerHtml += '<li><strong>연출</strong> <span>'
												+ data.list[i].direction
												+ '</span></li>';
										innerHtml += '<li><strong>극본</strong> <span>'
												+ data.list[i].play
												+ '</span></li>';
										innerHtml += '<li><strong>출연</strong> <span>'
												+ data.list[i].actor
												+ '</span></li>';
										innerHtml += '</ul>';
								...
								var $listLast = $("#dataUl").find(
										'li:last-child');
								$("#dataUl").append(innerHtml);
								$listLast.next().find('a:first-child').attr(
										'tabindex', '0');
