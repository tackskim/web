...
<body>
	...
	<center>
		<div id="container">
			<form name="frm" method="post" action="ViewerAddAction.do">
				<table cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>내용 :</td>
						<td><textarea name="VIEWCOMMENT_CONTENT" cols="67" rows="15"></textarea></td>
					</tr>
				</table>

				<div>
					<button type="submit" onclick="ViewerAddAction.do" class="button2">[글쓰기]</button>
